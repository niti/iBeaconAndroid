...
public class MonitoringActivity extends Activity implements IBeaconConsumer {
	...
	public void onIBeaconServiceConnect() {
		...
		try {
			// Below values for testing
			// Region region1=new Region("myMonitoringUniqueId",
			// "8DEEFBB9-F738-4297-8040-96668BB44281",1,338);
			Region region1 = new Region("myMonitoringUniqueId", null, null,
					null);
